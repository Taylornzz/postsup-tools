...
// set in their actual app (Resolve / Baselight / Nuke). Kaos Theory does NOT
...
export const ACES_INTEROP_WARNING =
  "Reference only — Kaos Theory doesn't apply these; set them in your grading app. Exact menu names vary by app & version. A shot graded under 1.3 looks different under 2.0 — don't switch versions mid-project.";
