...
export const DELIVERY_TEMPLATES: DeliveryTemplate[] = [
  ...
  { id: "netflix", name: "Netflix", spec: { region: "US", dr: "dolby-vision", peakNits: 1000, resolution: "UHD 3840×2160", fps: 23.976, container: "IMF App 2E", audio: "5.1.4 Atmos", loudness: "-27 LKFS (Netflix streaming)", truePeak: "-2 dBTP", subtitles: "Sidecar (IMSC/TTML)", textless: true, qc: "Photon + platform", notes: "Netflix original — Dolby Vision IMF for HDR (ProRes 4444 XQ + DoVi XML only by prior agreement); 25p in PAL territories. Starter spec (2026-06) — confirm the per-title Netflix spec." } },
